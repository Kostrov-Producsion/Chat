...
<script>
    ...
    export default {
        ...
        updated() {
            ...
            this.wsFriendAdd.onmessage = e => {
                ...
                if (action === 'create_friend') {
                    ...
                    var person_menu = clone.querySelector('.person-menu');
                    person_menu.onclick = this.BTNs;
            ...
            this.wsPerson.onmessage = e => {
                ...
                if (group === 'friend') {
                    ...
                    if (action === 'create_friend') {
                        ...
                        var person_menu = clone_c.querySelector('.person-menu');
                        person_menu.onclick = this.BTNs;
                        ...
                        var person_menu_1 = clone.querySelector('.person-menu');
                        person_menu_1.onclick = this.BTNs;
                        var message_btn = clone.querySelector('.message-btn');
                        message_btn.onclick = this.write_message;
                        var unsub_btn = clone.querySelector('.unsubscribe-btn');
                        unsub_btn.onclick = this.DeleteFriend;
        ...
        methods: {
            ...
            BTNs() {
                var parent = event.target.closest('.person');
